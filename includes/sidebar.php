<aside class="menu-sidebar d-none d-lg-block">
   ...
   <li>
                      ...
                      <li>
                          ...
                          <!-- enhance/shifa-->
                          <li>
                            <a href="House-Holders.php"  style="color: blue">  
                                <i class="fas fa-copy"></i>House Holders Details</a>   
                        </li> 
                        <!--enhance/shifa-->
                        <li>
                            <a href="maintenance.php"  style="color: blue">
                                <i class="fas fa-copy"></i>Maintenance Staff Details</a>   
                        </li> 
